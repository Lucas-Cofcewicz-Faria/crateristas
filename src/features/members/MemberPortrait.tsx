...
export function MemberPortrait({ avatarUrl, displayName, paletteSource = false }: { avatarUrl: string | null; displayName: string; paletteSource?: boolean }) {
    ...
    <div className={styles.avatarFrame}>
      {source && source !== failedSource ? (
        <Image
          ...
          data-profile-portrait={paletteSource ? 'true' : undefined}
          fill
