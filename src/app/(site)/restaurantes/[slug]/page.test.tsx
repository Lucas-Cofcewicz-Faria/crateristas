...
import RestaurantContent, { generateMetadata } from './page';
import SiteLayout from '../../layout';
const RestaurantPage = async (props: Parameters<typeof RestaurantContent>[0]) => SiteLayout({ children: await RestaurantContent(props) });
